...
echo $this->Html->css('summer/bootstrap.css');
...
<div class="container-fluid" style="background:rgba(34, 34, 34, 0);">
    <div class="row">
        ...
        <div class="col-sm-6">  
            <body style="background-image:url('<?php echo $this->Html->url('/img/pattern/summer.png', true) ?>'); center;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 pad_left_right">
                        ...
                        <div class="panel panel-warning" style="font-size:0.9em;">
                            <i class="left-inner-addon"><img id="callcorner" src="<?php echo $this->Html->url('/img/corner/summer.png', true) ?>" alt="..."></i>
                            ...
                            <div class="panel-body" >
                                ...
                                <div class="form-group control-group" style="font-size: 14px;">
                                    <p> You will get :</p>
