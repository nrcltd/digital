                ...
                <div class="container-fluid">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php
                                            echo $this->Html->url(array('controller' => 'products',
                    ...
                    <div class="col-md-5 pad_left_right">
                        ...
                        <div class="panel panel-warning" style="font-size:0.9em;">
                            <i class="left-inner-addon"><img id="callcorner" src="<?php echo $this->Html->url('/img/corner/' . $theme . '.png', true) ?>" alt="..."></i>
...
//                                    
                                        ...
                                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                                            <div class="paypal-form">
                                                ...
                                                <input type="hidden" name="notify_url" value="<?php echo $this->Html->url(array('plugin' => 'paypal_ipn', 'controller' => 'instant_payment_notifications', 'action' => 'process'), true); ?>">
                                                <input type="hidden" name="currency_code" value="USD">
                                                <input type="hidden" name="lc" value="US">
                                                <input type="hidden" name="item_name" value="Order <?php echo $order['Order']['id']. ': '.$product["Product"]['product_name'] ?>">
                                                ...
                                                <input type="hidden" name="return" value="<?php echo $this->Html->url(array('plugin' => '', 'controller' => 'orders', 'action' => 'bought'), true); ?>">
                                            </div>
                                            <div class="submit">
